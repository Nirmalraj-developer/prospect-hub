                        ...
                        {getAllFeatures().map(({ plan, feature }, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`relative bg-white border border-black/[0.06] rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-200 cursor-pointer fade-in-up ${locked
                                            ? 'opacity-75'
